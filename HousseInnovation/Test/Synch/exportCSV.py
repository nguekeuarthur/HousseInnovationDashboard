...
credential_path = os.path.join(current_directory, "myDhoola.json")

# Vérifiez si le fichier de crédential existe
if not os.path.exists(credential_path):
    raise FileNotFoundError(f"Fichier de crédential introuvable : {credential_path}")
