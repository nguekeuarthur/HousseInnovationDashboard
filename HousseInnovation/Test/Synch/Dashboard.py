...
with col6:
    st.markdown("<div style='background-color: #ffebee; padding: 10px; border-radius: 5px;'><strong>Temps Écoulé Total (minutes)</strong><br><h3>{:.2f}</h3></div>".format(temps_ecoule_moyen), unsafe_allow_html=True)
